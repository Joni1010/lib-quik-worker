...
namespace MarketObjects
{
    public class Position
    {
        ...
        public override string ToString()
        {
            if (Sec.NotIsNull())
            {
                return Sec.ToString() + ":" + Client.ToString();
            }
            return "";
        }

        /// <summary> Чистый обьем по текщущей позиции </summary>
        public int CurrentVolume
        {
            get { return Data.CurrentNet < 0 ? Data.CurrentNet * -1 : Data.CurrentNet; }
        }
        /// <summary> Текущее направление </summary>
        public OrderDirection CurrentDirection
        {
            get
            {
                if (CurrentVolume == 0)
                ...
                return Data.CurrentNet < 0 ? OrderDirection.Sell : OrderDirection.Buy;
            }
        }
        /// <summary> Если позиция sell то true, иначе false </summary>
        /// <returns></returns>
        public bool IsSell()
        {
            return CurrentDirection == OrderDirection.Sell ? true : false;
        }
        /// <summary> Если позиция buy то true, иначе false </summary>
        /// <returns></returns>
        public bool IsBuy()
        {
            return CurrentDirection == OrderDirection.Buy ? true : false;
        }
    }
}
