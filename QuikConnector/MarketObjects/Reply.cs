...
namespace MarketObjects
{
    ...
    {
        public delegate void eventTrans(IEnumerable<Reply> listTransReply);
        ...
        private List<Reply> ListEvents = new List<Reply>();
        private Mutex mutexEvent = new Mutex();

        public void NewTransReply(Reply trReply, bool generateEvent = true)
        {
        ...
        private void GenerateEvent()
        {
            ...
            try
            {
                ...
                ThreadStart eventMessage = () =>
                {
                    ...
                    {
                        mutexEvent.WaitOne();
                        IEnumerable<Reply> list = this.ListEvents.ToArray();
